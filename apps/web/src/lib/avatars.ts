...
export const AVATAR_PRESETS: (AvatarPreset & { emoji: string; colors: [string, string] })[] = [
  ...
  },
  {
    ...
    imageNotViewed: '/avatars/kat-links.png',
    imageViewed: '/avatars/kat-rechts.png',
  },
  {
    id: 'dog',
    name: 'Hond',
    ...
    imageNotViewed: '/avatars/dog-links.png',
    imageViewed: '/avatars/dog-rechts.png',
  },
  {
    id: 'owl',
    name: 'Uil',
  ...
  },
  {
    ...
    imageNotViewed: '/avatars/spook-links.png',
    imageViewed: '/avatars/spook-rechts.png',
  },
  {
    id: 'superhero',
    name: 'Superheld',
